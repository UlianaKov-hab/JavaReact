...
export const CropperDialog : React.FC<ICropperDialog> = ({
    ...
    const [currentImage, setCurrentImage] = useState("https://cdn-icons-png.flaticon.com/512/1053/1053244.png?w=360");
    ...
    //     if(files && files.length)       //перевіряє чи обраний файл зображення
    //     {
    //         const file = files[0];
   ...
   const handleImageSelect = (e: React.FormEvent<HTMLInputElement>) => {
    ...
    e.currentTarget.value = ""; //щоб можна було обирати одну і ту саму фотку два рази
   }
   const toggleModal = () =>{
       setShow(prev=>!prev);
   }
